...
//Común a Windows y a MACOSX
	...
	public void PR06() {
		...
		// Rellenamos el formulario.
		PO_RegisterView.fillForm(driver, "99999990B", "Josefo", "Per", "888888", "77777");
		// COmprobamos el error de contraseñas diferentes .
		PO_RegisterView.checkKey(driver, "Error.signup.passwordConfirm.coincidence", PO_Properties.getSPANISH());
		// Rellenamos el formulario.
		PO_RegisterView.fillForm(driver, "99999990B", "Josefo", "Per", "7", "7");
		// COmprobamos el error de contraseña demasiado cortas .
		PO_RegisterView.checkKey(driver, "Error.signup.password.length", PO_Properties.getSPANISH());
		// Rellenamos el formulario.
		PO_RegisterView.fillForm(driver, "9999990B", "Josefo", "Per", "77777", "77777");
		// Rellenamos el formulario.
		PO_RegisterView.fillForm(driver, "9999990B", "Josefo", "Per", "7", "8");
		// COmprobamos el error de contraseñas diferentes y demasiado cortas .
		PO_RegisterView.checkKey(driver, "Error.signup.passwordConfirm.coincidence", PO_Properties.getSPANISH());
		PO_RegisterView.checkKey(driver, "Error.signup.password.length", PO_Properties.getSPANISH());
	...
	/*
	 * PR07. Prueba del formulario de login. Identificación válida con usuario de
	 * ROL usuario ( 99999990A/123456).
	 */
	@Test
	public void PR07() {
	...
	/*
	 * PR08. Prueba del formulario de login. Identificación válida con usuario de
	 * ROL profesor ( 99999993D/123456).
	 */
	@Test
	public void PR08() {
		// Vamos al formulario de logueo.
	...
	/*
	 * PR09. Prueba del formulario de login. Identificación válida con usuario de
	 * ROL Administrador ( 99999988F/123456).
	 */
	@Test
	public void PR09() {
		// Vamos al formulario de logueo.
	...
	/*
	 * PR10. Prueba del formulario de login. Identificación inválida con usuario de
	 * ROL alumno ( 99999990A/123456).
	 */
	@Test
	public void PR10() {
		// Vamos al formulario de logueo.
		...
		// COmprobamos que nos redirige otra vez al login
		PO_View.checkElement(driver, "text", "Identifícate");
	}

	/*
	 * PR11. Prueba del formulario de login. Identificación válida y desconexión con
	 * usuario de ROL usuario ( 99999990A/123456).
	 */
	@Test
	public void PR11() {
		// Vamos al formulario de logueo.
	...
	public void PR12() {
		// Vamos al formulario de logueo.
		PO_PrivateView.fillFormLogin(driver, "login","class", "btn btn-primary",  "99999990A", "123456", "text", "Notas del usuario");
	...
	@Test
	public void PR14() {
		PO_PrivateView.fillFormLogin(driver, "login", "class", "btn btn-primary",  "99999993D", "123456", "text", "99999993D");
		...
		PO_PrivateView.goToPage(driver, 3, elementos);
